...
| `wiki-spec` | `preflight --new-spec <path> [--wiki=<path>] [--limit=10] [--include-archived] [--no-external] [--include-frozen-external]` | Spec history management. Before authoring a new spec (PRD / design / RFC / ADR / task-spec / decisi… |
