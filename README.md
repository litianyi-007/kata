...
| **Phase 1+** *(in flight)* | **Spec History Management (v1.13).** SDD / superpowers-style flows accumulate specs that drift apart over time. `wiki-spec preflight` makes new specs answer for the prior specs they overlap. Phase 0 (v2.2.0, advisory), Phase 1 (v2.3.0, external-source backfill), and Phase 2 (v2.4.0, ingest-time enforcement) shipped. Phase 3-4 add auto-propagation and lineage view. |
